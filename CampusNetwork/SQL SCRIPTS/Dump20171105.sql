...
CREATE TABLE `tbl_attendance` (
  ...
  KEY `srkey31` (`SSO`),
  KEY `srkey32` (`CourseId`),
  CONSTRAINT `srkey31` FOREIGN KEY (`SSO`) REFERENCES `tbl_student` (`SSO`),
  CONSTRAINT `srkey32` FOREIGN KEY (`CourseId`) REFERENCES `tbl_course` (`CourseId`)
...
INSERT INTO `tbl_instructor` VALUES (111,'Sam Ramajunan','F','sam.ramanujan@ucmo.edu',9999999999,'1983-07-30','sam'),(112,'Kamal','F','mustafa.kamal@ucmo.edu',9999999999,'1983-07-30','kamal');
...
--
-- Table structure for table `tbl_setattendance`
--

DROP TABLE IF EXISTS `tbl_setattendance`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tbl_setattendance` (
  ...
  `isGenerated` varchar(1) DEFAULT 'N',
  PRIMARY KEY (`Aid`),
  KEY `srkey33` (`CourseId`),
  KEY `srkey44` (`InstructorId`),
  CONSTRAINT `srkey33` FOREIGN KEY (`CourseId`) REFERENCES `tbl_course` (`CourseId`),
  CONSTRAINT `srkey44` FOREIGN KEY (`InstructorId`) REFERENCES `tbl_instructor` (`InstructorId`)
) ENGINE=InnoDB AUTO_INCREMENT=24 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `tbl_setattendance`
--

LOCK TABLES `tbl_setattendance` WRITE;
/*!40000 ALTER TABLE `tbl_setattendance` DISABLE KEYS */;
/*!40000 ALTER TABLE `tbl_setattendance` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `tbl_student` VALUES (12426401,'Rajesh Jonnalagadda','M','Masters','raj@ucmo.edu',8166823701,'1993-07-01','raj'),(12426402,'Sukanth','M','Masters','sukanth.gunda@ucmo.edu',8166823702,'1993-07-02','sukanth'),(12426403,'sumanth','M','Masters','sumanth.gunda@ucmo.edu',8166823703,'1993-07-03','sumanth'),(12426404,'kiran','M','Masters','kiran@ucmo.edu',8166823704,'1993-07-04','kiran'),(12426405,'balaji','M','Masters','balaji@ucmo.edu',8166823705,'1993-07-05','balaji'),(12426406,'sridhar','F','Masters','sridhar@ucmo.edu',8166823706,'1993-07-06','sridhar'),(12426407,'Bhargava Gellaboina','M','Masters','bha@ucmo.edu',8166823707,'1993-07-07','bha'),(12426408,'Surya Prabha Ghanta','F','Masters','sur@mail.ucmo.edu',8166823708,'1993-07-08','sur'),(12426409,'Gori Mehaboob','M','Masters','gor@mail.ucmo.edu',8166823709,'1993-07-09','gor'),(12426410,'Raghu vital Gummadi','M','Masters','rag@mail.ucmo.edu',8166823710,'1993-07-10','rag'),(12426411,'Haricharana Kanamarlapudi','F','Masters','har@mail.ucmo.edu',8166823711,'1993-07-11','har'),(12426412,'Rajesh Kapa','M','Masters','kap@mail.ucmo.edu',8166823712,'1993-07-12','kap'),(12426413,'Rahul Ponnada','M','Masters','rah@mail.ucmo.edu',8166823713,'1993-07-13','rah'),(12426414,'Sandhya Sannapareddy','F','Masters','san@mail.ucmo.edu',8166823714,'1993-07-14','san'),(12426415,'Anvesh Tummala','M','Masters','anv@mail.ucmo.edu',8166823715,'1993-07-15','anv'),(12426416,'Pooja Agrawal','F','Masters','poo@mail.ucmo.edu',8166823716,'1993-07-16','poo'),(12426417,'Jordan Larson','M','Masters','jor@mail.ucmo.edu',8166823717,'1993-07-17','jor'),(12426418,'Siddharth Gutha','M','Masters','sid@mail.ucmo.edu',8166823718,'1993-07-18','sid'),(12426434,'Sukanth Gunda','M','Masters','sgnw8@mail.ucmo.edu',8166823758,'1993-07-30','Sukanth'),(16186322,'Mohammed Zubair','M','Masters','mmz@mail.ucmo.edu',8166823463,'1991-10-23','Zubair');
...
-- Dump completed on 2017-11-05  1:15:47
