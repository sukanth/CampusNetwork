...
<body>
	...
	<div id="mainContent" class="container">
		<div id="analyze-performance-accordion">
			...
			<div>
				...
				<div class="form-group" style="margin-left: 200px;">
					<label style="float: left; margin-right: 5px; font-weight: bold;">Select
						Type Of Analysis :</label> <select class="form-control dropdown-toggle"
						id="analysisType" name="analysisType"
				...
				<div class="form-group assessement" style="margin-left: 200px;">
					<label style="float: left; margin-right: 5px; font-weight: bold;">Select
